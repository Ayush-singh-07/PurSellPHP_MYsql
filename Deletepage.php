...
if(isset($_POST['answer'])){
        ...
        $sql= "DELETE FROM  userrecords  WHERE id='$searchQuery'     ";
...
?>
    ...
    <h1>Delete User</h1>
    <div class="innerform">
    <form action="Deletepage.php?id=<?php echo $searchQuery; ?>" method="Post"> 
    ...
    <label>Address: </label><input class="inputs" type="text" id="address" name="Address" value="<?php echo $contact; ?>"><br><br>
    <input type="file" accept="image/*" id="file-input" name="picture"><br><br>
    <input class="submit" type="Submit" name="answer" id="answer" value="DELETE"/>
    </form>
    </div>
    </div>
